...
const RainbowMaterial = extend(rainbowMaterial)
...
export const Rainbow = ({ startRadius = 0, endRadius = 0.5, emissiveIntensity = 2.5, fade = 0.25, ...props }: RainbowProps) => {
  const material = useRef<InstanceType<typeof rainbowMaterial>>(null)
  ...
  return (
    <mesh scale={[length, length, 1]} {...props}>
      <planeGeometry />
